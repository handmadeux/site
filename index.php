        ...
        <script type="text/javascript">
            (function(e,b){if(!b.__SV){var a,f,i,g;window.mixpanel=b;b._i=[];b.init=function(a,e,d){function f(b,h){var a=h.split(".");2==a.length&&(b=b[a[0]],h=a[1]);b[h]=function(){b.push([h].concat(Array.prototype.slice.call(arguments,0)))}}var c=b;"undefined"!==typeof d?c=b[d]=[]:d="mixpanel";c.people=c.people||[];c.toString=function(b){var a="mixpanel";"mixpanel"!==d&&(a+="."+d);b||(a+=" (stub)");return a};c.people.toString=function(){return c.toString(1)+".people (stub)"};i="disable time_event track track_pageview track_links track_forms register register_once alias unregister identify name_tag set_config reset people.set people.set_once people.increment people.append people.union people.track_charge people.clear_charges people.delete_user".split(" ");
                for(g=0;g<i.length;g++)f(c,i[g]);b._i.push([a,e,d])};b.__SV=1.2;a=e.createElement("script");a.type="text/javascript";a.async=!0;a.src="undefined"!==typeof MIXPANEL_CUSTOM_LIB_URL?MIXPANEL_CUSTOM_LIB_URL:"file:"===e.location.protocol&&"//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js".match(/^\/\//)?"https://cdn.mxpnl.com/libs/mixpanel-2-latest.min.js":"//cdn.mxpnl.com/libs/mixpanel-2-latest.min.js";f=e.getElementsByTagName("script")[0];f.parentNode.insertBefore(a,f)}})(document,window.mixpanel||[]);
                    mixpanel.init("8b065a43fa93cbec992eb6e8e88f2fea");
        </script>
        <!-- end Mixpanel -->
    </head>
                ...
                <div class="main">
                    ...
                    <section class="container" id="make-experience">
                        ...
                        <div class="row-fluid head-line">
                            <p class="text-default">DESTAQUES</p>
                            <h2 class="title-section">Projetos inovadores</br> e estratégicos</h2>
                        </div>
                    ...
                    <!-- :clientes -->
                     ...
                     <!-- metodo: -->
                    <section class="container" id="metodo">
                    ...
                    <section class="container" id="idealizadores">
                        ...
                        <div class="row">
                            ...
                            <div class="idealizador">
                                ...
                                <div class="col col-md-6 idealizador-info">
                                    <h3 class="idealizador-name">Gustavo Burnier</h3>
                                    <p class="idealizador-bio text-default">Gustavo trabalhou e viveu por 22 anos em New York, Londres, Madrid, Buenos Aires e Paris.  Com MBA do INSEAD, foi Co-Fundador e CMO do Decolar.com, Head de Marketing do eBay na Espanha, e em Londres foi Global Business Director da JWT e Global Digital Director na WPP.  Desde que voltou ao Brasil em 2011, foi Sócio, Diretor de Gestão e Operações Digitais da AlmapBBDO. O foco da sua carreira é a transformação digital dos negócios.</p>
                                </div>
                    ...
                    <section class="container" id="contato">
                        <div class="row-fluid">
                            ...
                            <p class="default-text head-line">CONTATO</p></br>
                            ...
                            <form name="contact-fomr" method="post" class="contact-form">
                                ...
                                <label for="email">
                                    <input class="input-full" type="mail" name="email" value="" placeholder="E-mail">
                                </label>
                                <label for="msg">
                                    <textarea class="input-full" name="name" value="" placeholder="Mensagem"></textarea> 
                                </label>
                                <label class="box-cta">
