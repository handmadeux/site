...
if(!function_exists('op_define_vars')){
    ...
    function op_enqueue_backend_scripts()
    {
        ...
        // wp_enqueue_script(OP_SN.'-tiny-mce', includes_url() . 'js/tinymce/tinymce.min.js');
        // wp_enqueue_script('media-upload', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('media-upload');
        // wp_enqueue_script('word-count', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('editor', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('quicktags', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('wplink', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('wpdialogs-popup', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_style('wp-jquery-ui-dialog', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        // wp_enqueue_script('wp-fullscreen', false, array(OP_SN.'-tiny-mce'), OP_VERSION);
        ...
        if (OP_SCRIPT_DEBUG === '') {
            ...
            wp_enqueue_script(OP_SN.'-op-back-all', OP_JS.'op-back-all.min.js', array(OP_SN.'-op-jquery-base-all', 'jquery-ui-slider', 'farbtastic', 'jquery-ui-position', 'media-upload', 'thickbox', 'jquery-ui-sortable', 'swfupload-swfobject'), OP_VERSION);
