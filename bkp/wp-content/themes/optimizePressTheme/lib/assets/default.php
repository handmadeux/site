        ...
        if(defined('OP_PAGEBUILDER')){
            ...
            if (strpos($content, '[op_popup_button]') !== false) {
                ...
                if(defined('OP_LIVEEDITOR')){
                    ...
                    // $add_new_element_popup .= '<img src="' . OP_IMG . '/live_editor/add_new.png" alt="' . __('Add Element',OP_SN) . '" />';
                    $add_new_element_popup .= '<span>' . __('Add Element',OP_SN) . '</span>';
...
<li>
    ...
    static function recent_posts($atts){
        ...
        foreach( $recent_posts as $recent ){
            ...
            $recent_html .= '<li>
                <div class="thumb"><img src="'.$img_src.'" class="scale-with-grid" /></div>
                <div class="content">
