...
class OptimizePress_LiveEditor_Assets {
    ...
    static function liveeditor_elements($atts,$content=''){
                    ...
                    if (strpos($sc, 'feature_box') === 1 || strpos($sc, 'feature_box_creator') === 1 || strpos($sc, 'order_box') === 1
                        ...
                        $new_content .= '<div class="row element-container cf">
                            <div class="op-element-links">
                                <a class="element-parent-settings" href="#parent-settings">' . esc_attr__('Edit Parent Element',OP_SN) . '</a>
                                <a class="element-settings" href="#settings">' . esc_attr__('Edit Element',OP_SN) . '</a>
                                <a class="element-clone" href="#clone-element">' . esc_attr__('Clone Element',OP_SN) . '</a>
                                <a class="element-advanced" href="#op-le-advanced">' . __('Advanced Element Options',OP_SN) . '</a>
                                <a class="element-move" href="#move">' . __('Move',OP_SN) . '</a>
                                <a class="element-delete" href="#delete">' . __('Remove Element',OP_SN) . '</a>
                            </div>
        ...
        $newcontent = op_do_shortcode(op_clean_shortcode_content($content)) .
            (defined('OP_LIVEEDITOR') ? '<a href="#add_element" class="add-new-element"><span>' . __('Add Element', OP_SN) . '</span></a>' : '');
        return $newcontent;
